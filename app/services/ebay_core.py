...
_KEYWORD_THRESHOLD = 5  # skip keyword fallback if EPID/GTIN already returned this many results
...
PRODUCTS: Dict[str, ProductConfig] = {
    ...
    "2X2_COLLECTOR_BOX": ProductConfig(
        key="2X2_COLLECTOR_BOX", set_code="2X2",
        display_name="Double Masters 2022 Collector Booster Box",
        packs_per_box=4,
        epid="8054524532",
        gtin="0195166168951",
        upc_list=("195166168951",),
        mpn="D06510000",
        required_tokens=("double", "masters", "2022", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "booster pack", "collector booster pack"),
    ),
    "ACR_COLLECTOR_BOX": ProductConfig(
        key="ACR_COLLECTOR_BOX", set_code="ACR",
        display_name="Assassin's Creed Collector Booster Box",
        packs_per_box=12,
        gtin="0195166261270",
        upc_list=("195166261270",),
        mpn="D35850000",
        required_tokens=("assassin", "creed", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "play", "beyond", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "beyond booster", "booster pack", "collector booster pack"),
    ),
    "BLB_COLLECTOR_BOX": ProductConfig(
        key="BLB_COLLECTOR_BOX", set_code="BLB",
        display_name="Bloomburrow Collector Booster Box",
        packs_per_box=12,
        gtin="0195166257167",
        upc_list=("195166257167",),
        mpn="D34260000",
        required_tokens=("bloomburrow", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "BRO_COLLECTOR_BOX": ProductConfig(
        key="BRO_COLLECTOR_BOX", set_code="BRO",
        display_name="The Brothers' War Collector Booster Box",
        packs_per_box=12,
        epid="19056724689",
        gtin="0195166151243",
        upc_list=("195166151243",),
        mpn="D03120000",
        required_tokens=("brothers", "war", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "CMM_COLLECTOR_BOX": ProductConfig(
        key="CMM_COLLECTOR_BOX", set_code="CMM",
        display_name="Commander Masters Collector Booster Box",
        packs_per_box=4,
        epid="11060708020",
        gtin="0195166216683",
        upc_list=("195166216683",),
        mpn="WOCD2015",
        required_tokens=("commander", "masters", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "booster pack", "collector booster pack"),
    ),
    "DFT_COLLECTOR_BOX": ProductConfig(
        key="DFT_COLLECTOR_BOX", set_code="DFT",
        display_name="Aetherdrift Collector Booster Box",
        packs_per_box=12,
        gtin="0195166278759",
        upc_list=("195166278759",),
        mpn="D41320000",
        required_tokens=("aetherdrift", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "DSK_COLLECTOR_BOX": ProductConfig(
        key="DSK_COLLECTOR_BOX", set_code="DSK",
        display_name="Duskmourn: House of Horror Collector Booster Box",
        packs_per_box=12,
        epid="7072094647",
        gtin="0195166258652",
        upc_list=("195166258652",),
        mpn="D34460000",
        required_tokens=("duskmourn", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack",
                        "japanese", "japan", "jp"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "ECL_COLLECTOR_BOX": ProductConfig(
        key="ECL_COLLECTOR_BOX", set_code="ECL",
        display_name="Lorwyn Eclipsed Collector Booster Box",
        packs_per_box=12,
        required_tokens=("lorwyn", "eclipsed", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "EOE_COLLECTOR_BOX": ProductConfig(
        key="EOE_COLLECTOR_BOX", set_code="EOE",
        display_name="Edge of Eternities Collector Booster Box",
        packs_per_box=12,
        required_tokens=("edge", "eternities", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "FDN_COLLECTOR_BOX": ProductConfig(
        key="FDN_COLLECTOR_BOX", set_code="FDN",
        display_name="Foundations Collector Booster Box",
        packs_per_box=12,
        gtin="0195166261898",
        upc_list=("195166261898",),
        mpn="D36300000",
        required_tokens=("foundations", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "FIN_COLLECTOR_BOX": ProductConfig(
        key="FIN_COLLECTOR_BOX", set_code="FIN",
        display_name="Final Fantasy Collector Booster Box",
        packs_per_box=12,
        epid="10078716135",
        gtin="0195166270975",
        upc_list=("195166270975",),
        mpn="WCMGFINCB",
        required_tokens=("final", "fantasy", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "INR_COLLECTOR_BOX": ProductConfig(
        key="INR_COLLECTOR_BOX", set_code="INR",
        display_name="Innistrad Remastered Collector Booster Box",
        packs_per_box=12,
        gtin="0195166270012",
        upc_list=("195166270012",),
        required_tokens=("innistrad", "remastered", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "LCI_COLLECTOR_BOX": ProductConfig(
        key="LCI_COLLECTOR_BOX", set_code="LCI",
        display_name="The Lost Caverns of Ixalan Collector Booster Box",
        packs_per_box=12,
        epid="27063159847",
        gtin="0195166229973",
        upc_list=("195166229973",),
        mpn="D23920000",
        required_tokens=("lost", "caverns", "ixalan", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "LTR_COLLECTOR_BOX": ProductConfig(
        key="LTR_COLLECTOR_BOX", set_code="LTR",
        display_name="Lord of the Rings: Tales of Middle-earth Collector Booster Box",
        packs_per_box=12,
        epid="7059705823",
        gtin="0195166205038",
        upc_list=("195166205038",),
        mpn="D15240000",
        required_tokens=("lord", "rings", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "booster pack", "collector booster pack"),
    ),
    "MH2_COLLECTOR_BOX": ProductConfig(
        key="MH2_COLLECTOR_BOX", set_code="MH2",
        display_name="Modern Horizons 2 Collector Booster Box",
        packs_per_box=12,
        epid="19050652152",
        gtin="0630509925575",
        upc_list=("630509925575",),
        mpn="C78540000",
        required_tokens=("modern", "horizons", "2", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack", "3"),
        exclude_phrases=("draft booster", "booster pack", "collector booster pack", "modern horizons 3"),
    ),
    "MH3_COLLECTOR_BOX": ProductConfig(
        key="MH3_COLLECTOR_BOX", set_code="MH3",
        display_name="Modern Horizons 3 Collector Booster Box",
        packs_per_box=12,
        gtin="0195166253657",
        upc_list=("195166253657",),
        mpn="D32920000",
        required_tokens=("modern", "horizons", "3", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "MKM_COLLECTOR_BOX": ProductConfig(
        key="MKM_COLLECTOR_BOX", set_code="MKM",
        display_name="Murders at Karlov Manor Collector Booster Box",
        packs_per_box=12,
        epid="24064891268",
        gtin="0195166244884",
        upc_list=("195166244884",),
        mpn="D30260000",
        required_tokens=("murders", "karlov", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "MOM_COLLECTOR_BOX": ProductConfig(
        key="MOM_COLLECTOR_BOX", set_code="MOM",
        display_name="March of the Machine Collector Booster Box",
        packs_per_box=12,
        epid="6059707842",
        gtin="0195166208350",
        upc_list=("195166208350",),
        mpn="D17910000",
        required_tokens=("march", "machine", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "ONE_COLLECTOR_BOX": ProductConfig(
        key="ONE_COLLECTOR_BOX", set_code="ONE",
        display_name="Phyrexia: All Will Be One Collector Booster Box",
        packs_per_box=12,
        epid="27058866217",
        gtin="0195166185163",
        upc_list=("195166185163",),
        mpn="D11310000",
        required_tokens=("phyrexia", "one", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "booster pack", "collector booster pack"),
    ),
    "OTJ_COLLECTOR_BOX": ProductConfig(
        key="OTJ_COLLECTOR_BOX", set_code="OTJ",
        display_name="Outlaws of Thunder Junction Collector Booster Box",
        packs_per_box=12,
        gtin="0195166252469",
        upc_list=("195166252469",),
        mpn="D32620000",
        required_tokens=("outlaws", "thunder", "junction", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "RVR_COLLECTOR_BOX": ProductConfig(
        key="RVR_COLLECTOR_BOX", set_code="RVR",
        display_name="Ravnica Remastered Collector Booster Box",
        packs_per_box=12,
        epid="7063474783",
        gtin="0195166229287",
        upc_list=("195166229287",),
        required_tokens=("ravnica", "remastered", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "booster pack", "collector booster pack"),
    ),
    "SPM_COLLECTOR_BOX": ProductConfig(
        key="SPM_COLLECTOR_BOX", set_code="SPM",
        display_name="Marvel's Spider-Man Collector Booster Box",
        packs_per_box=12,
        required_tokens=("spider", "man", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "STX_COLLECTOR_BOX": ProductConfig(
        key="STX_COLLECTOR_BOX", set_code="STX",
        display_name="Strixhaven: School of Mages Collector Booster Box",
        packs_per_box=12,
        epid="13045031408",
        gtin="0630509958863",
        upc_list=("630509958863",),
        required_tokens=("strixhaven", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "booster pack", "collector booster pack"),
    ),
    "TDM_COLLECTOR_BOX": ProductConfig(
        key="TDM_COLLECTOR_BOX", set_code="TDM",
        display_name="Tarkir: Dragonstorm Collector Booster Box",
        packs_per_box=12,
        gtin="0195166281179",
        upc_list=("195166281179",),
        mpn="D42740000",
        required_tokens=("tarkir", "dragonstorm", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "TLA_COLLECTOR_BOX": ProductConfig(
        key="TLA_COLLECTOR_BOX", set_code="TLA",
        display_name="Avatar: The Last Airbender Collector Booster Box",
        packs_per_box=12,
        gtin="0195166290478",
        upc_list=("195166290478",),
        required_tokens=("avatar", "airbender", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "play booster", "booster pack", "collector booster pack"),
    ),
    "WOE_COLLECTOR_BOX": ProductConfig(
        key="WOE_COLLECTOR_BOX", set_code="WOE",
        display_name="Wilds of Eldraine Collector Booster Box",
        packs_per_box=12,
        epid="23061983988",
        gtin="0195166231945",
        upc_list=("195166231945",),
        mpn="D24690000",
        required_tokens=("wilds", "eldraine", "collector", "box"),
        require_any_phrases=("collector booster box", "collector box", "collector booster display"),
        exclude_tokens=("draft", "set", "play", "bundle", "case", "single", "opened", "empty", "pack"),
        exclude_phrases=("draft booster", "set booster", "play booster", "booster pack", "collector booster pack"),
    ),
...
class EbayBrowseClient:
    ...
    def iter_listings_for_product(
        ...
        *,
        ...
        # Tier 3: keyword fallback — skipped when Tier 1/2 already returned enough results
        if include_keyword_fallback and len(all_items) < _KEYWORD_THRESHOLD:
            name = product.display_name
            queries = [
                name,
                f"MTG {name}",
                f"Magic the Gathering {name}",
                product.mpn or "",
                *(product.upc_list or ()),
                product.gtin or "",
            ]
